...
var navbar = [{ Link: '/', Text: 'Home' }, { Link: '/newnote', Text: 'New note' }, { Link: '/discuss', Text: 'Discuss' }, { Link: '/auth', Text: 'Sign In' }, { Link: '/auth/logout', Text: 'Sign Out' }, { Link: '/workTimeTable', Text: 'Time Table' }];
