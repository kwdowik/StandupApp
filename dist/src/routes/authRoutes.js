...
var router = function router(nav) {
    ...
    authRouter.route('/').get(authController.getLoginPage);
    ...
    authRouter.route('/profile').all(authController.checkAuthentication).get(authController.signIn);

    authRouter.route('/register').get(authController.getRegisterPage).post(authController.register);
